...
const STABLE_UPDATE_MANIFEST_URL: &str = crate::build_info::STABLE_UPDATE_MANIFEST_URL;
const PREVIEW_UPDATE_MANIFEST_URL: &str = crate::build_info::PREVIEW_UPDATE_MANIFEST_URL;
