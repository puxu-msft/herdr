...
pub(crate) fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::IntegrationProviderList(_) => "integration.provider.list",
        Method::IntegrationProviderInstall(_) => "integration.provider.install",
        Method::IntegrationProviderUninstall(_) => "integration.provider.uninstall",
